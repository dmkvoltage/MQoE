      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.lightbulb_outline, color: Color(0xFF6C63FF), size: 24),
          ),
          SizedBox(width: 16),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  'Intelligent feedback prompts will appear when network quality drops below optimal thresholds.',
                  style: TextStyle(
                    color: Colors.grey[300],
                    fontSize: 14,
                  ),
